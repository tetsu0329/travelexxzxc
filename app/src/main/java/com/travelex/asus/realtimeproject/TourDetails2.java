...
public class TourDetails2 {
    ...
    public TourDetails2(String tourID, String userID, String tourLocation, String tourDate, String tourJoiner, String tourDescription, String tourItinerary,
                        String tourInclusion, String tourImage1, String tourImage2, String categoryisland, String categoryplace){
        this.tourID = tourID;
        this.userID = userID;
